...
export const ContextMenuItem = forwardRef<ComponentRef<typeof Radix.Item>, ContextMenuItemProps>(
  function ContextMenuItem({ icon, children, description, shortcut, badge, danger, className, ...rest }, ref) {
    return (
      <Radix.Item
        ref={ref}
...
export const ContextMenuSubTrigger = forwardRef<ComponentRef<typeof Radix.SubTrigger>, ContextMenuSubTriggerProps>(
  function ContextMenuSubTrigger({ icon, children, className, ...rest }, ref) {
    return (
