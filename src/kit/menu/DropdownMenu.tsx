...
export const DropdownMenuItem = forwardRef<ComponentRef<typeof Radix.Item>, DropdownMenuItemProps>(
  function DropdownMenuItem({ icon, children, description, shortcut, badge, danger, className, ...rest }, ref) {
    return (
      <Radix.Item
        ref={ref}
        data-danger={danger || undefined}
        className={cn(menuItemClass({ description: Boolean(description), danger }), className)}
        {...rest}
      >
        <MenuItemContent
          icon={icon}
...
export const DropdownMenuSubTrigger = forwardRef<ComponentRef<typeof Radix.SubTrigger>, DropdownMenuSubTriggerProps>(
  function DropdownMenuSubTrigger({ icon, children, className, ...rest }, ref) {
    return (
...
>(function DropdownMenuCheckboxItem({ icon, children, description, className, ...rest }, ref) {
  return (
    <Radix.CheckboxItem
      ref={ref}
      className={cn(menuItemClass({ description: Boolean(description) }), className)}
      {...rest}
    >
...
export const DropdownMenuRadioItem = forwardRef<ComponentRef<typeof Radix.RadioItem>, DropdownMenuRadioItemProps>(
  function DropdownMenuRadioItem({ children, description, className, ...rest }, ref) {
    return (
      <Radix.RadioItem
        ref={ref}
        className={cn(menuItemClass({ description: Boolean(description) }), className)}
