  ...
  return (
    <div className="agreement-page">
      ...
      <ScrollShadow className="agreement-content" size={72}>
        <h2>AIWC软件用户协议与隐私政策</h2>
        <p>欢迎您使用"AIWC"桌面软件（以下简称"本软件"）。在下载、安装、使用本软件之前，请您务必仔细阅读并充分理解本《软件用户协议与隐私政策》（以下简称"本协议"）。一旦您安装、使用本软件，即视为您已阅读、理解并同意接受本协议的全部条款。如您不同意本协议的任何内容，请立即停止使用本软件。</p>
